...
import banner from "../assets/AIAvengersBanner.jpg"; // Replace with your actual banner image
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="max-w-5xl bg-white rounded-lg px-8 py-6 text-xl">
        ...
        <ul className="list-disc list-inside text-gray-600">
          <li>Understand AI concepts like supervised/unsupervised learning, neural networks, and NLP.</li>
          <li>Build practical projects using real-world datasets and tools like Python, TensorFlow, and OpenCV.</li>
          <li>Develop an understanding of ethical AI, model bias, and responsible deployment.</li>
          <li>Explore advanced topics like Generative AI and create interactive AI applications.</li>
        </ul>
      </div>
